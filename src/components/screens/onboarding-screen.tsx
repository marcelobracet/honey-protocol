...
const INGREDIENTS = [
  { label: "Mel", Icon: HoneyDropIcon },
  { label: "Chá verde", Icon: TeaLeafIcon },
  { label: "Canela", Icon: CinnamonIcon },
  { label: "Gengibre", Icon: GingerIcon },
];
  ...
  return (
    <div className="px-5 pb-6 pt-2">
      <div className="flex flex-col items-center px-1.5 pb-2.5 pt-7 text-center">
        ...
        <div className="mb-2.5 text-[11px] font-bold uppercase tracking-[0.14em] text-honey-sage">
          Seu ritual da manhã
        </div>
        <h1 className="mb-3 font-display text-[30px] font-medium leading-[1.15] text-honey-text">
          O truque do
          <br />
          <em className="font-display italic text-honey-gold-light">mel</em> pra sua mente
          acordar
        </h1>
        <p className="mx-auto mb-7 max-w-[300px] text-[14.5px] leading-relaxed text-honey-text-dim">
          Uma mistura simples de mel, chá verde, canela e gengibre — pra você começar o dia com
          mais foco e presença.
        </p>

        <div className="mb-8 flex justify-center gap-3.5">
          {INGREDIENTS.map(({ label, Icon }, i) => (
            <motion.div
              key={label}
      ...
      <button
        ...
        className="mt-2.5 w-full rounded-xl py-2.5 text-[13px] font-semibold text-honey-text-dim"
      >
        Já conheço, ir pro meu ritual
      </button>
    </div>
  );
}
